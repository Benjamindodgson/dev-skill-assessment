...
def generate_reports(
    ...
    lines.append("- Defects (30%): valid bug ratio, severity weighting.")
    lines.append("- Hygiene (20%): repro steps present, attachments present.")
    lines.append("- Responsiveness (20%): median time to bug closure.")
    lines.append("")
